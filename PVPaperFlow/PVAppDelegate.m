...
PVDummyViewController *(^dummyMainViewController)(NSString *) = ^(NSString *title) {
    PVDummyViewController *vc = [PVDummyViewController new];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    PVPaperFlowViewController *exampleCV = [[PVPaperFlowViewController alloc] initWithViewControllers:@[
